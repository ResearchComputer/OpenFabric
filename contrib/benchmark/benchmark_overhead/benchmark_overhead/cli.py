...
def doctor(head_url: str, config_path: str | None) -> None:
    ...
    from contrib.benchmark.benchmark_overhead.benchmark_overhead.doctor import run_doctor
...
def deploy(config_path: str, teardown: bool, run_id: str | None) -> None:
    ...
    from contrib.benchmark.benchmark_overhead.benchmark_overhead.deploy import run_deploy, run_teardown
...
def run(config_path: str, output_dir: str) -> None:
    ...
    from contrib.benchmark.benchmark_overhead.benchmark_overhead.run import run_sweep
...
def report(run_dir: str) -> None:
    ...
    from contrib.benchmark.benchmark_overhead.benchmark_overhead.report import render_report
